...
public class OverworldSapling extends BlockSapling {
    ...
    public void updateTick(World world, int x, int y, int z, Random random) {
        ...
        if (world.getBlockLightValue(x, y + 1, z) >= 9 && random.nextInt(120) == 0) {
            ...
            else func_149878_d(world, x, y, z, random);
        }
    }
    ...
    public void func_149878_d(World world, int x, int y, int z, Random random) {
        ...
        if (md == 1) obj = new RareTreeGen(true, 4, 2, 1, 1);
        else if (md == 2) obj = new RareTreeGen(true, 9, 8, 2, 2);
        else if (md == 3) obj = new RareTreeGen(true, 6, 4, 3, 3);
        else if (md == 4) obj = new WillowGen(true);
        else obj = new RareTreeGen(true, 4, 2, 0, 0);
