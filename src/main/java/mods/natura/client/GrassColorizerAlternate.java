...
public class GrassColorizerAlternate {
    ...
    public static void setBlueGrassBiomeColorizer(int[] par0ArrayOfInteger) {
        if (par0ArrayOfInteger.length == 65536) {
            ...
            Natura.logger.warn(
                    "Invalid texture for blue grass biome colors: expected 256x256 (65536) pixels, got {}!",
                    par0ArrayOfInteger.length);
        }
    }
    ...
    public static void setOrangeGrassBiomeColorizer(int[] par0ArrayOfInteger) {
        if (par0ArrayOfInteger.length == 65536) {
            ...
            Natura.logger.warn(
                    "Invalid texture for orange grass biome colors: expected 256x256 (65536) pixels, got {}!",
                    par0ArrayOfInteger.length);
        }
    }
