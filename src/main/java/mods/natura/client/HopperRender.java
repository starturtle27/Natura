...
public class HopperRender implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderBlockHopper(BlazeHopper par1BlockHopper, int par2, int par3, int par4, RenderBlocks renderer) {
        ...
        return this.renderBlockHopperMetadata(
                ...
                par3,
                par4,
                renderer.blockAccess.getBlockMetadata(par2, par3, par4),
                false,
                renderer);
    }
    ...
    public boolean renderBlockHopperMetadata(BlazeHopper par1BlockHopper, int par2, int par3, int par4, int par5,
        ...
        if (par6) {
            ...
            renderer.renderFaceYNeg(
                    ...
                    0.0D,
                    0.0D,
                    renderer.getBlockIconFromSideAndMetadata(par1BlockHopper, 0, par5));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, 1.0F, 0.0F);
            renderer.renderFaceYPos(
                    ...
                    0.0D,
                    0.0D,
                    renderer.getBlockIconFromSideAndMetadata(par1BlockHopper, 1, par5));
            tessellator.draw();
            tessellator.startDrawingQuads();
            ...
            renderer.renderFaceZNeg(
                    ...
                    0.0D,
                    0.0D,
                    renderer.getBlockIconFromSideAndMetadata(par1BlockHopper, 2, par5));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(0.0F, 0.0F, 1.0F);
            renderer.renderFaceZPos(
                    ...
                    0.0D,
                    0.0D,
                    renderer.getBlockIconFromSideAndMetadata(par1BlockHopper, 3, par5));
            tessellator.draw();
            tessellator.startDrawingQuads();
            ...
            renderer.renderFaceXNeg(
                    ...
                    0.0D,
                    0.0D,
                    renderer.getBlockIconFromSideAndMetadata(par1BlockHopper, 4, par5));
            tessellator.draw();
            tessellator.startDrawingQuads();
            tessellator.setNormal(1.0F, 0.0F, 0.0F);
            renderer.renderFaceXPos(
                    ...
                    0.0D,
                    0.0D,
                    renderer.getBlockIconFromSideAndMetadata(par1BlockHopper, 5, par5));
            tessellator.draw();
        } else {
