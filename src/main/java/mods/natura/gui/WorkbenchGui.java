...
public class WorkbenchGui extends GuiContainer {
     ...
     * fontRenderer.drawString("Crafting", 28, 6, 0x404040); fontRenderer.drawString("Inventory", 8, (ySize - 96) + 2,
     * 0x404040); } protected void drawGuiContainerBackgroundLayer (float f, int i, int j) { GL11.glColor4f(1.0F, 1.0F,
     * 1.0F, 1.0F); mc.renderEngine.bindTexture("/gui/crafting.png"); int l = (width - xSize) / 2; int i1 = (height -
