...
public class MRFRegistering {
    public static void registerWithMFR () {
        ...
        if (PHNatura.enableNetherBerryBushes) {
            FactoryRegistry.sendMessage(registerPlantable, new PlantableNaturaNetherBerry(Item.getItemFromBlock(NContent.netherBerryBush), NContent.netherBerryBush));
        ...
        if (PHNatura.enableBerryBushes) {
            FactoryRegistry.sendMessage(registerPlantable, new PlantableNaturaBerry(Item.getItemFromBlock(NContent.berryBush), NContent.berryBush));
        ...
        FactoryRegistry.sendMessage(registerPlantable, new PlantableStandard(Item.getItemFromBlock(NContent.floraSapling), NContent.floraSapling));
