...
public class PHNatura {
    ...
    public static void initProps (File confFile) {
        ...
        canRespawnInNether = config.get(catDisabler, "Obelisks let players respawn in the Nether", true).getBoolean(true);
        ...
        enableWoodenPressurePlates = config.get(catWoodProducts, "Enable Wooden Pressure Plates", true).getBoolean(true);
