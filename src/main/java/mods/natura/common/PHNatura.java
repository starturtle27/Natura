...
public class PHNatura {
    ...
    public static void initProps(File confFile) {
        ...
        Natura.retrogen =
                config.get("Retrogen", "Retroactive Generation", false).getBoolean(false);
        ...
        babyHeatscarMinimum = config.get(catMobChanges, "Minimum Baby Heatscar Spiders on Spider Death", 2)
                .getInt(2);
        if (babyHeatscarMinimum < 0) babyHeatscarMinimum = 0;
        babyHeatscarMaximum = config.get(catMobChanges, "Maximum Baby Heatscar Spiders on Spider Death", 4)
                .getInt(4);
        ...
        generateRedwood =
                config.get(catDisabler, "Generate Redwood Trees", true).getBoolean(true);
        generateSakura = config.get(catDisabler, "Generate Sakura Trees", true).getBoolean(true);
        generateSmallEucalyptus =
                config.get(catDisabler, "Generate Small Eucalyptus Trees", true).getBoolean(true);
        generateBush = config.get(catDisabler, "Generate Hopseed Trees", true).getBoolean(true);
        generateBloodwood =
                config.get(catDisabler, "Generate Bloodwood Trees", true).getBoolean(true);
        generateGhost = config.get(catDisabler, "Generate Ghost Trees", true).getBoolean(true);
        generateSaguaro =
                config.get(catDisabler, "Generate Saguaro Cactus", true).getBoolean(true);

        generateOverworldClouds =
                config.get(catDisabler, "Generate Overworld Clouds", true).getBoolean(true);
        generateSulfurClouds =
                config.get(catDisabler, "Generate Sulfur Clouds", true).getBoolean(true);
        generateAshClouds = config.get(catDisabler, "Generate Ash Clouds", true).getBoolean(true);
        generateDarkClouds =
                config.get(catDisabler, "Generate Dark Clouds", true).getBoolean(true);

        generatePurpleheart =
                config.get(catDisabler, "Generate Amaranth Trees", true).getBoolean(true);
        generateWillow = config.get(catDisabler, "Generate Willow Trees", true).getBoolean(true);
        generateTiger =
                config.get(catDisabler, "Generate Tigerwood Trees", true).getBoolean(true);
        generateSilverbell =
                config.get(catDisabler, "Generate Silverbell Trees", true).getBoolean(true);
        generateMaple = config.get(catDisabler, "Generate Maple Trees", true).getBoolean(true);

        generateDarkwood =
                config.get(catDisabler, "Generate Darkwood Trees", true).getBoolean(true);
        generateFusewood =
                config.get(catDisabler, "Generate Fusewood Trees", true).getBoolean(true);
        generateThornvines =
                config.get(catDisabler, "Generate Thornvines", true).getBoolean(true);
        ...
        generateBluebells =
                config.get(catDisabler, "Generate Bluebell Flowers", true).getBoolean(true);

        generateBlueberries =
                config.get(catDisabler, "Generate Blueberry Bushes", true).getBoolean(true);
        generateBlackberries =
                config.get(catDisabler, "Generate Blackberry Bushes", true).getBoolean(true);
        generateRaspberries =
                config.get(catDisabler, "Generate Raspberry Bushes", true).getBoolean(true);
        generateMaloberries =
                config.get(catDisabler, "Generate Maloberry Bushes", true).getBoolean(true);

        generateBlightberries =
                config.get(catDisabler, "Generate Blightberry Bushes", true).getBoolean(true);
        generateDuskberries =
                config.get(catDisabler, "Generate Duskberry Bushes", true).getBoolean(true);
        generateSkyberries =
                config.get(catDisabler, "Generate Skyberry Bushes", true).getBoolean(true);
        generateStingberries =
                config.get(catDisabler, "Generate Stingberry Bushes", true).getBoolean(true);

        generateGreenglowshroom =
                config.get(catDisabler, "Generate Green Glowshroom", true).getBoolean(true);
        generatePurpleglowshroom =
                config.get(catDisabler, "Generate Purple Glowshroom", true).getBoolean(true);
        generateBlueglowshroom =
                config.get(catDisabler, "Generate Blue Glowshroom", true).getBoolean(true);
        generateGlowshroomtree =
                config.get(catDisabler, "Generate Glowshroom Trees", true).getBoolean(true);
        dropCotton =
                config.get(catDisabler, "Drop cotton seeds from grass", true).getBoolean(true);
        dropBarley =
                config.get(catDisabler, "Drop barley seeds from grass", true).getBoolean(true);

        enableNitroCreepers =
                config.get(catDisabler, "Enable Nitro Creepers", true).getBoolean(true);
        enableImps = config.get(catDisabler, "Enable Imps", true).getBoolean(true);
        enableHeatscarSpiders =
                config.get(catDisabler, "Enable Heatscar Spiders", true).getBoolean(true);
        if (enableNitroCreepers | enableImps | enableHeatscarSpiders) anyMobsEnabled = true;

        try {
            Class.forName("chococraft.common.ModChocoCraft");
            enableWheatRecipe = config.get(catDisabler, "Enable wheat to flour recipe", false)
                    .getBoolean(false);
        } catch (Exception e) {
            enableWheatRecipe = config.get(catDisabler, "Enable wheat to flour recipe", true)
                    .getBoolean(true);
        }

        redwoodSpawnRarity =
                config.get(catWorldgen, "Redwood Tree Spawn Rarity", 150).getInt(150);
        bloodSpawnRarity =
                config.get(catWorldgen, "Blood Tree Spawn Rarity", 14).getInt(14);
        eucalyptusShortSpawnRarity = config.get(catWorldgen, "Small Eucalyptus Tree Spawn Rarity", 25)
                .getInt(25);
        eucalyptusShortSpawnRange =
                config.get(catWorldgen, "Small Eucalyptus Tree Spawn Range", 32).getInt(32);
        sakuraSpawnRarity =
                config.get(catWorldgen, "Sakura Tree Spawn Rarity", 10).getInt(10);
        sakuraSpawnRange =
                config.get(catWorldgen, "Sakura Tree Spawn Range", 32).getInt(32);
        ghostSpawnRarity =
                config.get(catWorldgen, "Ghostwood Tree Spawn Rarity", 10).getInt(10);
        ...
        purpleheartRarity =
                config.get(catWorldgen, "Amaranth Tree Spawn Rarity", 1).getInt(1);
        ...
        silverbellRarity =
                config.get(catWorldgen, "Silverbell Tree Spawn Rarity", 70).getInt(70);

        darkSpawnRarity =
                config.get(catWorldgen, "Darkwood Tree Spawn Rarity", 10).getInt(10);
        fuseSpawnRarity =
                config.get(catWorldgen, "Fusewood Tree Spawn Rarity", 50).getInt(50);

        saguaroSpawnRarity =
                config.get(catWorldgen, "Saguaro Cactus Spawn Rarity", 5).getInt(5);
        ...
        darkCloudSpawnRarity =
                config.get(catWorldgen, "Dark Cloud Spawn Density", 10).getInt(10);
        darkCloudSpawnHeight =
                config.get(catWorldgen, "Dark Cloud Spawn MinX", 0).getInt(64);
        darkCloudSpawnRange =
                config.get(catWorldgen, "Dark Cloud Spawn Range", 256).getInt(256);
        sulfurSpawnRarity =
                config.get(catWorldgen, "Sulfur Cloud Spawn Rarity", 8).getInt(8);
        sulfurSpawnHeight =
                config.get(catWorldgen, "Sulfur Cloud Spawn Height", 40).getInt(40);
        sulfurSpawnRange =
                config.get(catWorldgen, "Sulfur Cloud Spawn Range", 78).getInt(78);
        ...
        blackSpawnRarity =
                config.get(catWorldgen, "Blackberry Spawn Rarity", 48).getInt(48);
        ...
        blightSpawnRarity =
                config.get(catWorldgen, "Blightberry Spawn Rarity", 18).getInt(18);
        blightSpawnRange =
                config.get(catWorldgen, "Blightberry Spawn Range", 100).getInt(100);
        ...
        stingSpawnRarity =
                config.get(catWorldgen, "Stingberry Spawn Rarity", 18).getInt(18);
        stingSpawnRange = config.get(catWorldgen, "Stingberry Spawn Range", 100).getInt(100);

        thornSpawnRarity =
                config.get(catWorldgen, "Thornvines Spawn Rarity", 40).getInt(40);
        darkCloudBlacklist = config.get(catWorldgen, "dimension blacklist(dark clouds)", new int[] {})
                .getIntList();
        cloudBlacklist = config.get(catWorldgen, "dimension blacklist(clouds)", new int[] {})
                .getIntList();
        sulfurCloudBlacklist = config.get(catWorldgen, "dimension blacklist(sulfur clouds)", new int[] {})
                .getIntList();

        enableWoodenBookshelves =
                config.get(catWoodProducts, "Enable Wooden Bookshevles", true).getBoolean(true);
        enableWoodenButtons =
                config.get(catWoodProducts, "Enable Wooden Buttons", true).getBoolean(true);
        enableWoodenDoors =
                config.get(catWoodProducts, "Enable Wooden Doors", true).getBoolean(true);
        enableWoodenFenceGates =
                config.get(catWoodProducts, "Enable Wooden Fence Gates", true).getBoolean(true);
        enableWoodenFences =
                config.get(catWoodProducts, "Enable Wooden Fences", true).getBoolean(true);
        enableWoodenPressurePlates = config.get(catWoodProducts, "Enable Wooden Pressure Plates", true)
                .getBoolean(true);
        enableWoodenSlabs =
                config.get(catWoodProducts, "Enable Wooden Slabs", true).getBoolean(true);
        enableWoodenStairs =
                config.get(catWoodProducts, "Enable Wooden Stairs", true).getBoolean(true);
        enableWoodenTrapdoors =
                config.get(catWoodProducts, "Enable Wooden Trapdoors", true).getBoolean(true);
        enableWoodenWorkbenches =
                config.get(catWoodProducts, "Enable Wooden Workbenches", true).getBoolean(true);

        enableBerryBushes = config.get(catOverworldProducts, "Enable Berries and Berry Bushes", true)
                .getBoolean(true);
        enableBonemealBags =
                config.get(catOverworldProducts, "Enable Bonemeal Bags", true).getBoolean(true);
        enableCactusJuice =
                config.get(catOverworldProducts, "Enable Cactus Juice", true).getBoolean(true);
        enableSeedBags =
                config.get(catOverworldProducts, "Enable Seed Bags", true).getBoolean(true);

        enableBlazeHoppers =
                config.get(catNetherProducts, "Enable Blaze Hoppers", true).getBoolean(true);
        enableBlazeRails =
                config.get(catNetherProducts, "Enable Blaze Rails", true).getBoolean(true);
        enableFlintAndBlaze =
                config.get(catNetherProducts, "Enable Flint And Blaze", true).getBoolean(true);
        enableNetherBerryBushes = config.get(catNetherProducts, "Enable Nether Berries and Berry Bushes", true)
                .getBoolean(true);
        enableNetherButtons =
                config.get(catNetherProducts, "Enable Netherack Buttons", true).getBoolean(true);
        enableNetherFurnaces =
                config.get(catNetherProducts, "Enable Netherack Furnaces", true).getBoolean(true);
        enableNetherGlass =
                config.get(catNetherProducts, "Enable Nether Glass", true).getBoolean(true);
        enableNetherWoodTools =
                config.get(catNetherProducts, "Enable Nether Wood Tools", true).getBoolean(true);
        enableNetherLevers =
                config.get(catNetherProducts, "Enable Netherack Levers", true).getBoolean(true);
        enableNetherPressurePlates = config.get(catNetherProducts, "Enable Netherack Pressure Plates", true)
                .getBoolean(true);
        enableNetherWartBags =
                config.get(catNetherProducts, "Enable Nether Wart Bags", true).getBoolean(true);
        enableObelisks = config.get(catNetherProducts, "Enable Obelisks", true).getBoolean(true);
        enableQuartzTools =
                config.get(catNetherProducts, "Enable Quartz Tools", true).getBoolean(true);
