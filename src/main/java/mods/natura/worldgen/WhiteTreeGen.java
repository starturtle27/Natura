...
public class WhiteTreeGen extends WorldGenAbstractTree {
    ...
    void func_150529_a(int p_150529_1_, int p_150529_2_, int p_150529_3_, float p_150529_4_, byte p_150529_5_, Block block) {
    ...
    boolean validTreeLocation() {
        ...
        boolean isSoil = block.canSustainPlant(worldObj, basePos[0], basePos[1] - 1, basePos[2], ForgeDirection.UP, (BlockSapling)Blocks.sapling) || block == Blocks.netherrack;
        if (!isSoil) {
            return false;
        } else {
    ...
    int findGround (World world, int x, int y, int z) {
        ...
        do {
            ...
            if (blockBelow == Blocks.netherrack || blockBelow == Blocks.soul_sand || blockBelow == NContent.taintedSoil || height < 0)
                foundGround = true;
        } while (!foundGround);
        return height + 1;
    }
