...
public class BushTreeGen extends WorldGenerator {
    ...
    public BushTreeGen(boolean notify, int height, int mdwood, int mdleaves) {
        super(notify);
            ...
            if (!var7) {
                ...
                if ((b8 == Blocks.grass || b8 == Blocks.dirt) && y < 256 - var6 - 1) {
                    ...
                    for (var10 = 0; var10 < var6; ++var10) {
                        ...
                        if (b8 == Blocks.air || b8.isLeaves(world, x, y + var10, z)) {
