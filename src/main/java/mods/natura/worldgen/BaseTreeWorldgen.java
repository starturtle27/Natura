...
public class BaseTreeWorldgen implements IWorldGenerator {
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator,
        ...
        if (biomeName.equals("Forest") || biomeName.equals("AutumnWoods")
                || biomeName.equals("BirchForest")
                || biomeName.equals("PineForest")
                || biomeName.equals("Rainforest")
                || biomeName.equals("TemperateRainforest")
                || biomeName.equals("Woodlands")) {
        ...
        if (biomeName.equals("Plains") || biomeName.equals("Meadow")) {
            ...
            if (PHNatura.generateSmallEucalyptus
                    && random.nextInt((int) (PHNatura.eucalyptusShortSpawnRarity * 1.5)) == 0) {
                xSpawn = xPos + random.nextInt(16);
        ...
        if (biomeName.equals("Extreme Hills") || biomeName.equals("Extreme Hills Edge")
                || biomeName.equals("ForestedHills")
                || biomeName.equals("GreenHills")) {
        ...
        if (biomeName.equals("Desert") || biomeName.equals("DesertHills")
                || biomeName.equals("Lush Desert")
                || biomeName.equals("Hot Desert")
                || biomeName.equals("Oasis")) {
